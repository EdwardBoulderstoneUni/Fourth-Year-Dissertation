...
public struct SerializedPlayer {
    ...
    public bool Equals(SerializedPlayer other) => location == other.location && velocity == other.velocity && grounded == other.grounded;
    ...
    public static bool operator==(SerializedPlayer lhs, SerializedPlayer rhs){
        return lhs.location == rhs.location && lhs.velocity == rhs.velocity && lhs.grounded == rhs.grounded;
    }
    public static bool operator!=(SerializedPlayer lhs, SerializedPlayer rhs){
        return !(lhs == rhs);
    }
